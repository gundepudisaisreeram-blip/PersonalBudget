...
@section('title', 'Record an expense — Personal Budget Manager')

@section('content')
    <h1 class="h3 mb-4">Record an expense</h1>

    <div class="card">
        <div class="card-body">
            <form method="POST" action="{{ route('transactions.expense.store') }}" novalidate>
                @csrf
